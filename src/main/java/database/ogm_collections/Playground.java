...
public class Playground {
    ...
    private Set<Bruger> assignedUsers = new HashSet<>();
...
/* @OneToOne
    ...
    private Bruger assignedUser;*//*


    //@ManyToMany(mappedBy = "playgrounds", cascade = CascadeType.PERSIST)
    //private Set<Bruger> connectedUsers = new HashSet<>();

    //@OneToMany(mappedBy = "user", cascade = CascadeType.PERSIST)
    //private Set<Bruger> assignedUsers = new HashSet<>();
    @Override
    public String toString() {
        for (Bruger user : assignedUsers) {
    ...
    public Set<Bruger> getAssignedUsers() {
        return assignedUsers;
    }

    public void setAssignedUsers(Set<Bruger> assignedUsers) {
